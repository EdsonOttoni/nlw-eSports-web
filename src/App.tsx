...
function App() {
  ...
  return (
    <div className='max-w-[1344px] mx-auto flex flex-col items-center mt-20'>
      <img className='w-[300px] h-[200px]' src={logoImg} alt="" />
      ...
      <div className='grid grid-cols-6 gap-6 mt-16'>
        ...
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0'>
            <strong className='text-sm font-bold text-white block'>Counter Strike</strong>
            <span className='text-zinc-300 text-sm mt-1 block'>4 anúncios</span>
          </div>
        </a>
        <a href="" className='relative rounded-lg overflow-hidden'>
        ...
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0'>
            <strong className='text-sm font-bold text-white block'>World WarCraft</strong>
            <span className='text-zinc-300 text-sm mt-1 block'>4 anúncios</span>
          </div>
        </a>
      </div>
      ...
      <div className='pt-1 bg-nlw-gradient self-stretch rounded-lg mt-8 overflow-hidden'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
          <div>
            ...
            <span className='text-zinc-400 block'>Publique anúncio para encontrar novos players!</span>
          </div>

          <button className='py-3 px-4 bg-violet-500 text-white rounded flex itens-center gap-3 hover:bg-violet-600'>
